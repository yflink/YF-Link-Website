    ...
    return (
      <div className={classes.root}>
        ...
        <div className={classes.proposalContainer}>
          ...
          <div className={classes.field}>
            <Typography className={classes.fieldMessage} variant="h5">
              You must have staked 0.1 YFL in the{" "}
            ...
            <Typography className={classes.fieldMessage} variant="h5">
              Append{" "}
              <Typography className={classes.code}>?type=meme</Typography> to
              the proposal URL to submit in the memes category.
            </Typography>
          </div>
          <Button
            className={classes.stakeButton}
